...
I feel like the craft of creating beautiful software is being thrown to the side in pursuit of maximum "productivity". productivity in quotes because I'm not convinced we're actually being more productive. What does productive programming look like in todays age? Some swear by [LOC (lines of code)](https://x.com/garrytan/status/2038555792052506941) and I would argue this has never been a good metric in programming, in fact I would say this is a negative sign if you're pushing this much code out into the world. More output does not mean *good* output.
